...
const SharedHostingCard = ({ name, price, space, bandwidth, addon, subdomain, database, email, backups, cpu, ram, entryprocess, io, controlpanel,to }) => {
    return (
        <>
            <div className="max-w-full rounded-xl border border-gray-300 hover:shadow-lg hover:shadow-gray-300 py-6 px-6 duration-300 bg-white space-y-3">
                ...
                <div className="space-y-1">
                    ...
                    <div className="text-base flex items-center gap-2">
                        <FaSquareCheck className='text-blue-500' />
